...
// EJEMPLO DE USO:
altaDeLibro(3, "Node.js para Expertos", 10); // Resuelve Issue #7
if (descontarStock(1)) { // Resuelve Issue #5
    imprimirComprobante("Ludmila Ramirez", ["JavaScript Moderno"]); // Resuelve Issue #6
}